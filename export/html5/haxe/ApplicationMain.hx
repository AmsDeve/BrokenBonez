...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BrokenBones", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("BrokenBones", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "BrokenBones";
		app.meta["name"] = "BrokenBones";
